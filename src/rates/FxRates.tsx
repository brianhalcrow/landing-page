...
const FxRates = ({ baseCurrency, setBaseCurrency }) => {
  ...
  const { data: forwardPoints, isLoading: loadingForwardPoints } =
    useForwardPointsData(baseCurrency, termCurrencies, tenors);
  const { data: hedgeExposures, isLoading: loadingHedgeExposures } =
    useHedgeExposures();
